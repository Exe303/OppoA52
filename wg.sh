...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/Exe303/OppoA52/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/Exe303/OppoA52/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/Exe303/OppoA52/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/Exe303/OppoA52/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
